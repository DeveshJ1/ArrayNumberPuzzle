...
index zero to the last index in the array. At each step we need to know the distance to be traveled and the direction. Each entry in the array is a number 
indicating the distance to be traveled on this particular leg of the path. TThe player (your program) needs to decide the direction (if the move should be made to
...
-designing a program from scratch (deciding what classes and method should be part of the program)<br>
